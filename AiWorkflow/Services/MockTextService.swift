...
final class MockTextService: AITextServiceProtocol {
    ...
    static let mockCopy = """
    [{"cardIndex":0,"topText":"你又一次把聊天记录翻到最上面，想看看他最开始是怎么叫你的。","bottomText":"原来一个人变心前，连标点符号都会变。你该把这份温柔留给自己了。"},{"cardIndex":1,"topText":"他说只是加班，你信了。可是这个月他已经加了三十二天班了。","bottomText":"你不是傻，你只是不想承认——一个装睡的人，叫不醒，但你可以选择先醒。"},{"cardIndex":2,"topText":"领导拍拍你的肩说能者多劳，于是同事的活全变成了你的活。","bottomText":"能者多劳的下半句是——多劳者，未必多得。你的善良应该有底线。"},{"cardIndex":3,"topText":"你妈说：不结婚就是不孝。这句话从你25岁听到了35岁。","bottomText":"孝顺不是活成别人想要的样子，而是有勇气活成自己。"},{"cardIndex":4,"topText":"你帮他找了一万种借口，其实真相只有一个——他没你想象中那么在乎。","bottomText":"别再帮他找理由了，你值得被明目张胆的偏爱，而不是遮遮掩掩的凑合。"},{"cardIndex":5,"topText":"你说没事，然后一个人把委屈咽了回去。这是你今天第三次说没事了。","bottomText":"懂事不是你的天赋，是你受过伤的证明。从今天起，先照顾好自己，再对世界温柔。"}]
    """
