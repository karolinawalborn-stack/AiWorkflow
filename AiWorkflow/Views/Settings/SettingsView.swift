        ...
        NavigationStack {
            List {
                ...
                Section {
                    ...
                    VStack(alignment: .leading, spacing: 4) { Text("任务查询路径").font(.caption).foregroundColor(.secondary); TextField("/v1/media/query", text: $vm.imageTaskQueryEndpointPath).autocapitalization(.none).disableAutocorrection(true) }
